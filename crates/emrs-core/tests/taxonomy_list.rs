...
async fn setup_db(tag: &str) -> emrs_core::db::Db {
...
async fn ins_genre(db: &emrs_core::db::Db, name: &str) -> i64 {
...
async fn ins_person(db: &emrs_core::db::Db, tmdb: &str, name: &str) -> i64 {
...
async fn ins_studio(db: &emrs_core::db::Db, name: &str) -> i64 {
...
async fn link_genre(db: &emrs_core::db::Db, item_id: i64, genre_id: i64) {
...
async fn link_person(db: &emrs_core::db::Db, item_id: i64, people_id: i64) {
...
async fn link_studio(db: &emrs_core::db::Db, item_id: i64, studio_id: i64) {
...
/// 断言库过滤去重、跨库隔离、无过滤全量。
async fn seed_two_libraries(db: &emrs_core::db::Db) -> (i64, i64) {
...
fn titles(rows: &[emrs_core::stores::ItemRow]) -> Vec<String> {
